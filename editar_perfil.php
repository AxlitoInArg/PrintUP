...
$DNI = $_SESSION['datos_usuario']['id_usuario'] ?? null; // Asegurar que $DNI esté definido
$nombres = $_SESSION['datos_usuario']['Nombres'] ?? '';
$apellidos = $_SESSION['datos_usuario']['Apellidos'] ?? '';
$email_actual = $_SESSION['datos_usuario']['Email'] ?? '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($nombre) && !empty($apellido)) {
        ...
        $_SESSION['datos_usuario']['Nombres'] = $nombre;
        $_SESSION['datos_usuario']['Apellidos'] = $apellido;
        $_SESSION['datos_usuario']['Nombre_Completo'] = $nombre . " " . $apellido;
